...
// ignore: unused_element
  ForecastInfoData call(@nullable String latitude, @nullable String longitude,
      @nullable String elevation) {
...
class _$ForecastInfoData implements ForecastInfoData {
  const _$ForecastInfoData(@nullable this.latitude, @nullable this.longitude,
      @nullable this.elevation);
...
abstract class ForecastInfoData implements ForecastInfo {
  const factory ForecastInfoData(
      @nullable String latitude,
      @nullable String longitude,
      @nullable String elevation) = _$ForecastInfoData;
