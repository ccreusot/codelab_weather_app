...
mixin _$LocationStatus {
  ...
  TResult when<TResult extends Object>({
    @required TResult success(Location location),
    @required TResult error(String message),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult success(Location location),
    TResult error(String message),
    @required TResult orElse(),
  });
  @optionalTypeArgs
  TResult map<TResult extends Object>({
    @required TResult success(LocationSuccess value),
    @required TResult error(LocationError value),
  });
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object>({
    TResult success(LocationSuccess value),
    TResult error(LocationError value),
    @required TResult orElse(),
  });
}
