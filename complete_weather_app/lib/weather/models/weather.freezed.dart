...
mixin _$WeatherStatus {
  ...
  TResult when<TResult extends Object>({
    @required TResult success(Weather weather),
    @required TResult error(String message),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult success(Weather weather),
    TResult error(String message),
    @required TResult orElse(),
  });
  @optionalTypeArgs
  TResult map<TResult extends Object>({
    @required TResult success(WeatherSuccess value),
    @required TResult error(WeatherError value),
  });
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object>({
    TResult success(WeatherSuccess value),
